...
#
#lbl = tk.Label(root, text="Covid Detection using X-Ray and Future Forecasting", font=('times', 35,' bold '), height=1,bg="Red3",fg="white")
...
#root.geometry("%dx%d+0+0" % (300, 700))
